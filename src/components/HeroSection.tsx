...
const HeroBG = require('../images/bg.png');
          ...
          <div className="section-wrapper relative z-20 w-full max-w-[1360px] mx-auto lg:px-10 px-4 pb-14">
              <div className="top-box md:mb-4 text-center">
                <div className="flex justify-center items-start flex-wrap">
                    <div className="btn flex items-center justify-center sm:w-40 w-32 lg:min-h-[90px] min-h-[70px] py-1 px-2 bg-black/50 text-center md:mx-8 sm:mx-4 mx-2">
                        <div className="inner">
                ...
                <a href="/" className='inline-block rounded-md px-10 lg:py-3 py-2 lg:text-base text-sm text-white m-4 transition ease-in bg-black'>Harvest</a>
              </div>
